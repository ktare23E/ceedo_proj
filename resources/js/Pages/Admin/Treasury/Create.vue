...
const submit = () => {
    Swal.fire({
        title: 'Are you sure?',
        text: "Do you want to register this treasurer?",
        icon: 'question',
        ...
        if (result.isConfirmed) {
            form.post(route('store_treasury'), {
                onSuccess: () => {
                    Swal.fire({
                        icon: 'success',
                        title: 'Treasury Created!',
                        text: 'The treasurer has been successfully created.',
                        timer: 2000,
...
<template>
    <AdminLayout :title="'Create Treasurer'" :header="'Create Treasurer'">
        <div class="flex items-center justify-center min-h-[80vh]">
            <div class="bg-white shadow-xl rounded-2xl p-8 w-3/4 border border-gray-100 relative">
                ...
                <h2 class="text-2xl font-semibold text-gray-800 text-center mb-6">Create Treasurer</h2>
