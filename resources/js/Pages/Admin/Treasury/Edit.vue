...
const submit = () => {
    Swal.fire({
        title: 'Are you sure?',
        text: "Do you want to update this treasurer information?",
        icon: 'question',
        ...
        if (result.isConfirmed) {
            form.post(route('update_treasury'), { // ✅ use PUT for updating
                onSuccess: () => {
                    Swal.fire({
                        icon: 'success',
                        title: 'Treasury Updated!',
                        text: 'The treasury information has been successfully updated.',
                        timer: 2000,
                        showConfirmButton: false,
                    }).then(() => {
                        router.visit(route('treasury'));
                    });
                },
                onError: () => {
                    Swal.fire({
    ...
    <AdminLayout :title="'Edit Treasurer'" :header="'Edit Treasurer'">
        <div class="flex items-center justify-center min-h-[80vh]">
            <div class="bg-white shadow-xl rounded-2xl p-8 w-3/4 border border-gray-100 relative">
                ...
                <h2 class="text-2xl font-semibold text-gray-800 text-center mb-6">Edit Treasurer</h2>
