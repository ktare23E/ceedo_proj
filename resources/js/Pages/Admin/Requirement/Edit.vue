...
const form = useForm({
    ...
    requirement_name: props.requirement.requirement_name,
...
const submit = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            form.post(route('update_requirement'), {
                onSuccess: () => {
                    Swal.fire({
                        icon: 'success',
                        title: 'Requirement Updated!',
                        text: 'The requirement has been successfully updated.',
                        timer: 2000,
                ...
                onError: () => {
                    Swal.fire({
                        icon: 'error',
                        title: 'Update requirement failed',
...
<template>
    <AdminLayout :title="'Edit Requirement'" :header="'Edit Requirement'">
        <div class="flex items-center justify-center min-h-[80vh]">
            <div class="bg-white shadow-xl rounded-2xl p-8 w-3/4 border border-gray-100 relative">
                ...
                <h2 class="text-2xl font-semibold text-gray-800 text-center mb-6">Edit Requirement</h2>
